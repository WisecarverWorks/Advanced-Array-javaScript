...
problemFour()
let chickpeas = problemFour();
console.log("Dishes with chickpeas: ", chickpeas)

//////6a. Create a function that will return an array of only the names of the cuisine types. Ie ['Italian', 'Mexican', ...]
//////Map
function problemSixa() {
    let resultArray = dishes.map(function (element) {
        if (element == element.cuisine) {
            return true;
        }
        else {
            return false;
...
problemSixa()
let result = problemSixa();
console.log("Cuisine Types: ", resultArray ) 
